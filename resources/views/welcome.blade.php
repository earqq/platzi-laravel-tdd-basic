    ...
    <body class="bg-gray-200 py-10">
        <div class="max-w-lg bg-white mx-auto p-5 rounded shadow">
            <form action='tags' method="POST" class="flex mb-4">
                @csrf
                <input type="text" name='name' class="rounded-1 bg-gray-200 p-4 w-full outline-none" placeholder="Nueva etiqueta">
                <input type="submit" value="Agregar" class="rounded-1 px-8 bg-blue-500 text-white outline-none">
            </form>
